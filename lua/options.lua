...
vim.opt.wrap = true                               -- do wrap lines by default
...
vim.o.autocomplete = true                                    -- Automatically triggers popup menu as you type
vim.o.autocompletedelay = 100                                -- Milliseconds to wait before showing suggestions
vim.o.complete =
".,w,b,o^20"                                                 -- Sources: current buffer (.), windows (w), buffers (b), LSP/omnifunc (o)
vim.o.completeopt = "menuone,noselect,fuzzy,nosort,nearest," -- Use native fuzzy matching & show menu always
vim.o.pumheight = 10                                         -- Limit completion menu height to 10 rows
